      ...
      <div className="w-full max-w-3xl bg-gray-600 backdrop-blur-md rounded-xl shadow-xl p-8">
        ...
        <div className="mt-6 space-y-3 text-white text-lg">
          <ul className="list-disc list-inside">
            <li>島根未来共創チャレンジ 2025 U-18 AWARD</li>
            <li>中高生Rubyプログラミングコンテスト 2025 審査員特別賞</li>
            <li>早寝早起き朝ごはんアプリコンテスト 開発部門 最優秀賞（文部科学大臣賞）</li>
            <li>2023年度 全国選抜小学生プログラミング大会 審査員特別賞</li>
            <li>2023年度 島根県小学生プログラミング大会 最優秀賞</li>
            <li>2022年度 全国選抜小学生プログラミング大会 みんなのみらい賞</li>
            <li>2022年度 島根県小学生プログラミング大会 最優秀賞</li>
          </ul>
        </div>
